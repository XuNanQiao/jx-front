 ...
 * @LastEditTime: 2026-01-20 14:08:32
 * @LastEditors: ZHAO
 * @Description:
 * @FilePath: \jx\src\views\deployment\tabs\DataBrowse.vue
 *
-->
<template>
...
import { browseColumns, statusMap, statusOptions } from "../../development/indexData";
